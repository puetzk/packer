// Code generated by "hcl2-schema -type AlicloudDiskDevice,AlicloudDiskDevices"; DO NOT EDIT.\n
...
func (*AlicloudDiskDevices) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_disk_mappings": &hcldec.BlockListSpec{TypeName: "[]AlicloudDiskDevice", Nested: hcldec.ObjectSpec((&AlicloudDiskDevices{}).ECSImagesDiskMappings[0].HCL2Spec())},
	}
	return s
}
