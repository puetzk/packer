...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"AttachSnapshot":       &hcldec.AttrSpec{Name: "attach_snapshot", Type: cty.String, Required: false},
		"TargetSnapshot":       &hcldec.AttrSpec{Name: "target_snapshot", Type: cty.String, Required: false},
		"DeleteTargetSnapshot": &hcldec.AttrSpec{Name: "force_delete_snapshot", Type: cty.Bool, Required: false},
