...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"source_omi_filter": &hcldec.BlockObjectSpec{TypeName: "osccommon.OmiFilterOptions", LabelNames: []string(nil), Nested: hcldec.ObjectSpec((&Config{}).SourceOMIFilter.HCL2Spec())},
	}
	for k, v := range (&Config{}).OMIBlockDevices.HCL2Spec() {
		s[k] = v
	}
